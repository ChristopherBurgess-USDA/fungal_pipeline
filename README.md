...
- [ ] fill in `README.md` TODOs form the auto generated `nf-core`
- [ ] add in the `itsxpress` module to the `main.nf` and fill in TODO
- [ ] Call `nf-core` `fastqc` and `multiqc` modules and fill in relevant info
...
**nf-core/fungal_pipeline** is a bioinformatics pipeline that ...
...
```bash
nextflow run nf-core/fungal_pipeline \
...
nf-core/fungal_pipeline was originally written by Chris Burgess.
...
<!-- If you use nf-core/fungal_pipeline for your analysis, please cite it using the following doi: [10.5281/zenodo.XXXXXX](https://doi.org/10.5281/zenodo.XXXXXX) -->
